...
<div class="max-w-2xl mx-auto space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-xl font-bold text-slate-900">Register Customer</h1>
            <p class="text-xs text-slate-500">Add patient or customer profile for sales tracking.</p>
        </div>
    ...
    <form action="{{ route('customers.store') }}" method="POST" class="bg-white rounded-3xl border border-slate-200/80 shadow-sm p-6 sm:p-8 space-y-4">
        @csrf
        ...
        <div>
            ...
            <textarea name="notes" rows="3" placeholder="Allergies, chronic conditions, notes..."
        ...
        <div class="pt-4 border-t border-slate-100 flex justify-end gap-3">
            <a href="{{ route('customers.index') }}" class="px-5 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-xl text-xs font-bold">Cancel</a>
